...
export const openLetter = {
  ...
  signedByLabel:
    "Signed by 2388 members of a voluntary effort to respond to the Port of Tyne Nurdle Spill",
  paragraphs: [
